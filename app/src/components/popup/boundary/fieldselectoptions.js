...
export const FIELD_STATUS_ZUORDNUNG = [
  { value: "00", label: "nicht gesetzt" },
  { value: "01", label: "DM2" },
  { value: "02", label: "BRK" },
  { value: "03", label: "KHK" },
...
export const FIELD_STATUS_STATUSKENNZEICHEN = [
...
export const FIELD_PRACTQUALI_CODE = [
  { value: "00", label: "Arzt" },
